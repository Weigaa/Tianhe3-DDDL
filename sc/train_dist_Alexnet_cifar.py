...
def average_gradients(model):
    ...
    for param in model.parameters():
        ...
        # print("rank ",dist.get_rank(),"before allreduce param.grad.data is ",param.grad.data.tolist())
        dist.all_reduce(param.grad.data, op=dist.reduce_op.SUM)
        param.grad.data /= size
        # print("rank ", dist.get_rank(), "after allreduce param.grad.data is ", param.grad.data.tolist())
